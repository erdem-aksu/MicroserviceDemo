...
using MicroserviceDemo.ReportService.DbMigrations;
...
[DependsOn(
    ...
    typeof(ReportServiceHttpApiModule),
    typeof(AbpAspNetCoreMvcUiMultiTenancyModule),
    typeof(AbpHttpClientIdentityModelWebModule),
    typeof(AbpIdentityHttpApiClientModule)
)]
public class ReportServiceHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        var configuration = context.Services.GetConfiguration();

        JwtBearerConfigurationHelper.Configure(context, "ReportService");
        ...
        SwaggerConfigurationHelper.ConfigureWithAuth(
            ...
            scopes: new
                ...
                {
                    { "ReportService", "Report Service API" },
    ...
    public override async Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        await context.ServiceProvider
            .GetRequiredService<ReportServiceDatabaseMigrationChecker>()
