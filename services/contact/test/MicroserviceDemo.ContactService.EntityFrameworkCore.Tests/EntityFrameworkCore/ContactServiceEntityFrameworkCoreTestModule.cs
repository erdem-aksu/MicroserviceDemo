...
[DependsOn(
    typeof(ContactServiceTestBaseModule),
    typeof(ContactServiceEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class ContactServiceEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        new ContactServiceDbContext(
                new DbContextOptionsBuilder<ContactServiceDbContext>().UseSqlite(connection).Options
