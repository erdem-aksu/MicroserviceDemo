...
namespace MicroserviceDemo.AdministrationService
{
    ...
    public class AdministrationServiceDomainSharedModule : AbpModule
    {
        ...
        {
            Configure<AbpVirtualFileSystemOptions>(options => { options.FileSets.AddEmbedded<AdministrationServiceDomainSharedModule>(); });
            ...
            Configure<AbpExceptionLocalizationOptions>(options => { options.MapCodeNamespace("AdministrationService", typeof(AdministrationServiceResource)); });
        }
    }
}