using MicroserviceDemo.IdentityService.Localization;
...
namespace MicroserviceDemo.IdentityService
{
    ...
    public class IdentityServiceDomainSharedModule : AbpModule
    {
        ...
        {
            Configure<AbpVirtualFileSystemOptions>(options => { options.FileSets.AddEmbedded<IdentityServiceDomainSharedModule>(); });
