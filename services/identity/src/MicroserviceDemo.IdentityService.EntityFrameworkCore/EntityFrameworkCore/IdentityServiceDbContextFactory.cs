    ...
    public class IdentityServiceDbContextFactory : IDesignTimeDbContextFactory<IdentityServiceDbContext>
    {
        public IdentityServiceDbContext CreateDbContext(string[] args)
        {
            ...
            var builder = new DbContextOptionsBuilder<IdentityServiceDbContext>()
                .UseNpgsql(GetConnectionStringFromConfiguration(), b => { b.MigrationsHistoryTable("__IdentityService_Migrations"); });
            ...
            var builder = new ConfigurationBuilder()
                .SetBasePath(
                    Path.Combine(
                        ...
                        $"..{Path.DirectorySeparatorChar}MicroserviceDemo.IdentityService.HttpApi.Host"
                    )
                )
